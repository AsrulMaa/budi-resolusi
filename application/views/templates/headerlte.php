...
<head>
  ...
  <title><?php echo $title.$users['name']; ?></title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             <img src="" class="user-image" alt="User Image"><!-- <?php echo base_url('assets/admin/').$users['image'];?> -->
              <span class="hidden-xs"><!-- <?= $users['name']; ?> --></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="" class="img-circle" alt="User Image"><!-- <?php echo base_url('assets/admin/').$users['image'];?> -->
